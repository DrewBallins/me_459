// ME 459 HW06 task5
// Author: Andrew Wild
// This c program function randomT2 to make a random 1000x1000 matrix A and multiplies
...
int main() {
	...
	// multiplying A*b column-wise and placing values in c vector
	for(int k=0; k<1000; k++) {
		for(int l=0; l<1000; l++) {
			c[l] = c[l] + A[l*1000 + k]*b[k];
		}
	}
